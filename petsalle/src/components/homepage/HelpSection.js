...
import help from "../../assets/help.jpg"; // Ensure the image path is correct
import vector from "../../assets/Vector.png"; // Ensure the image path is correct
  ...
  return (
    ...
    >
      <div className="max-w-lg p-6 bg-opacity-50 text-white">
        {/* Flex container for h1 and vector image */}
        <div className="flex items-center mb-4">
          <h1 className="text-4xl font-bold text-[#003459]">Adoption</h1>
          <img src={vector} alt="Vector" className="ml-4 w-8 h-8" /> {/* Adjust width and height as needed */}
        </div>
